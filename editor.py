...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.groupBox_2.setGeometry(QtCore.QRect(60, 220, 421, 101))
        self.groupBox_2.setObjectName("groupBox_2")
        self.unknownAnimationParam = QtWidgets.QCheckBox(self.groupBox_2)
        self.unknownAnimationParam.setGeometry(QtCore.QRect(20, 20, 211, 17))
        self.unknownAnimationParam.setCheckable(False)
        self.unknownAnimationParam.setObjectName("unknownAnimationParam")
        self.label_5 = QtWidgets.QLabel(self.groupBox_2)
        self.label_5.setGeometry(QtCore.QRect(20, 50, 101, 16))
        self.label_5.setObjectName("label_5")
        self.unknownParam14HEX = QtWidgets.QLineEdit(self.groupBox_2)
        self.unknownParam14HEX.setGeometry(QtCore.QRect(110, 50, 113, 20))
        self.unknownParam14HEX.setReadOnly(True)
        self.unknownParam14HEX.setObjectName("unknownParam14HEX")
        self.unknownParam14 = QtWidgets.QLineEdit(self.groupBox_2)
        self.unknownParam14.setGeometry(QtCore.QRect(230, 50, 113, 20))
        self.unknownParam14.setReadOnly(True)
        self.unknownParam14.setObjectName("unknownParam14")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.unknownAnimationParam.setText(_translate("MainWindow", "unknownAnimationParam"))
        self.label_5.setText(_translate("MainWindow", "unknownParam14"))
